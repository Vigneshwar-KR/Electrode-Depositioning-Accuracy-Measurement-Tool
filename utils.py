...
def process_images(folder_path):
    ...
    for image_name in os.listdir(folder_path):
        ...
        if image_name.lower().endswith(('.jpg', '.jpeg')):
            ...
            distance_1_2, distance_1_3 = None, None
            distance_1_2_in_mm, distance_1_3_in_mm = None, None
            ...
            if circles is not None:
                ...
                if len(circles) >= 12:
                    ...
                    distance_1_2 = math.sqrt((mid_group1_x - mid_group2_x)**2 + (mid_group1_y - mid_group2_y)**2)
                    distance_1_3 = math.sqrt((mid_group1_x - mid_group3_x)**2 + (mid_group1_y - mid_group3_y)**2)
                    
                    conversion_factor = 0.07281  # our calculated value
                    distance_1_2_in_mm = distance_1_2 * conversion_factor
                    distance_1_3_in_mm = distance_1_3 * conversion_factor
            ...
            all_data.append({
                ...
                'Distance Group 1-2 [pixels]': distance_1_2,
                'Distance Group 1-3 [pixels]': distance_1_3,
                'Distance Group 1-2 [mm]': distance_1_2_in_mm,
                'Distance Group 1-3 [mm]': distance_1_3_in_mm
            })
